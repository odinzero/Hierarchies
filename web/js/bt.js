...
function submitForm_btree(e) {
    ...
    $('#menu-binary-tree-form').append(input);
    ...
    var input = $("<input>")
                .attr("type", "hidden")
                .attr("name", "selectedCountry[selectedCountry]").val("" + sel_label[1]);
        $('#menu-binary-tree-form').append(input);
    
    document.getElementById('menu-binary-tree-form').submit();
}
