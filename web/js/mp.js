...
function submitForm_mp(e) {
    ...
    $('#menu-tree-mp-form').append(input);
    ...
    var input = $("<input>")
                .attr("type", "hidden")
                .attr("name", "selectedFood[selectedFood]").val("" + sel_label[1]);
        $('#menu-tree-mp-form').append(input);
    
    document.getElementById('menu-tree-mp-form').submit();
}
