...
!function(a, b) {
    ...
    r.Tween = Xa, Xa.prototype = {constructor: Xa, init: function(a, b, c, d, e, f) {
        ...
        }, _default: "swing"}, r.fx = Xa.prototype.init, r.fx.step = {};
    ...
    r.ajaxSetup({jsonp: "callback", jsonpCallback: function() {
        ...
        return h > -1 && (d = r.trim(a.slice(h)), a = a.slice(0, h)), r.isFunction(b) ? (c = b, b = void 0) : b && "object" == typeof b && (e = "POST"), g.length > 0 && r.ajax({url: a, type: e || "GET", dataType: "html", data: b}).done(function(a) {
