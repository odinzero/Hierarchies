...
//    print_r($menuItems);
 ...
 //   echo $url ;
   ...
   <!-- <form class="form" action="/index.php?r=dragdropnested%2Ftreemenu2" method="post" id="menu-tree-form"> -->
    <?= Html::beginForm(['/dragdropnested/treemenu2'], 'post', ['id' => "menu-tree-form" ]) ?>
    <?=
      Yii::$app->MyMenu::widget([
        //'items' => $menuItems,  
        'items' => Yii::$app->MenuArray::getData(),
        ...
        //'linkTemplate' => '<a href="{url}" data-method="{method}" style="display: {display};" >{label}</a>',
